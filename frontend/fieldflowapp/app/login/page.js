...
export default function Login() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const redirect = ROLE_ROUTES[data.user.role] || "/";
      ...
      <div className="w-full max-w-6xl grid lg:grid-cols-2 gap-10 items-center">
        ...
        <div className="w-full max-w-md bg-white/90 backdrop-blur rounded-3xl shadow-2xl border border-orange-100 p-8 mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-4xl font-extrabold text-[#2D2F39]">Welcome Back</h1>
          ...
          <form className="mt-8 space-y-5" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <input
                ...
                required
                className="w-full rounded-2xl border border-gray-300 px-4 py-3 mt-2 focus:border-orange-500 focus:ring-2 focus:ring-orange-200 outline-none transition"
              />
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-orange-500 hover:bg-orange-600 active:scale-[0.98] transition-all text-white py-3 rounded-2xl font-semibold shadow-lg disabled:opacity-60 disabled:cursor-not-allowed"
            >
