  ...
  <p className="mt-3 text-gray-500 leading-relaxed">
    ...
    and manage your home services with ease.
        ...
        <form className="mt-8 space-y-5">
          ...
          <div>
            <label className="block text-am font-medium mb-2">
              Email
            </label>
          ...
          <button
            className="w-full bg-orange-500 hover:bg-orange-600 active:scale-[0.98] transition-all text-white py-3 rounded-2xl font-semibold shadow-lg"
          >
            Sign In
          </button>
