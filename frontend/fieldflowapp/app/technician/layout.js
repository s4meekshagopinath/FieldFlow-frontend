...
const navItems = [
  ...
  { href: "/technician/jobs", label: "Assigned Jobs", icon: ClipboardList },
      ...
      >
        ...
        <div className="px-6 py-6 flex items-center gap-3 border-b border-white/5">
          ...
          <div>
            ...
            <p className="text-[11px] text-slate-400 font-medium">Technician Portal</p>
          </div>
        </div>
          ...
          <div>
            ...
            <nav className="space-y-1.5">
              {navItems.map(({ href, label, icon: Icon }) => {
                const active = pathname === href || (href === "/technician/dashboard" && pathname === "/technician");
                return (
                  <Link
                    key={href}
                    href={href}
              ...
              {showProfile && (
                <div className="absolute right-0 top-12 w-56 bg-white rounded-2xl shadow-xl border border-slate-100 z-50 overflow-hidden py-1">
                  <div className="px-5 py-3.5 bg-slate-900 text-white">
                    ...
                    <p className="text-slate-400 text-xs mt-0.5">{user?.email || "tech@fieldflow.com"}</p>
